        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item mt-1"><a class="nav-link active" aria-current="page" href="#">Home</a></li>
                    <li class="nav-item mt-1"><a class="nav-link" href="#about">About</a></li>
                    <li class="nav-item mt-1"><a class="nav-link" href="#pizza">Pizza</a></li>
                    <li class="nav-item mt-1"><a class="nav-link" href="#contact">Contact</a></li>
                    <li class="nav-item mt-1"><span class="nav-link text-success">{{ Auth()->user()->name }}</span></li>
